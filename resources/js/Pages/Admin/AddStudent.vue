...
const submit = () => {
    console.log(form)
    form.post(route('AddStudent'), {
        onFinish: () => {
            flash('Student Agregado!', 'Se agrego correctamente al usuario', 'success'),
...
<template>
    <form @submit.prevent="submit" class="p-4 flex-col justify-around items-center">
        ...
        <div class="mt-4">
            ...
            <select v-if="classrooms.length > 0" id="classroom" v-model="form.classroom_id" required
        ...
        <div class="mt-4">
            ...
            <TextInput id="level" type="text" class="mt-1 block w-full" v-model="form.level" required autofocus
                autocomplete="level" />
